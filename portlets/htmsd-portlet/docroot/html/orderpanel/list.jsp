...
<div class="orderlist">
	<liferay-ui:search-container delta="10" iteratorURL="<%= iteratorURL %>" emptyResultsMessage="no-records-found">
        ...
        <liferay-ui:search-container-row className="com.htmsd.slayer.model.ShoppingOrder" modelVar="shoppingOrder">
            ...
            <liferay-ui:search-container-column-text name="order-id" value="<%= "HTMSD_"+shoppingOrder.getOrderId() %>"/>
            ...
            <liferay-ui:search-container-column-text name="order-date">
           		<%=  HConstants.DATE_FORMAT.format(shoppingOrder.getCreateDate()) %>
            </liferay-ui:search-container-column-text>
            
            <liferay-ui:search-container-column-text name="status">
            	<%= tabName.equalsIgnoreCase("Pending") ? HConstants.PENDING_STATUS:HConstants.DELIVERED_STATUS %>
            </liferay-ui:search-container-column-text>
            
            <liferay-ui:search-container-column-text name="action" >
            	<aui:a href="<%= detailsURL %>"><liferay-ui:message key="view"/></aui:a>
            </liferay-ui:search-container-column-text>   
